...
class EditarServicio extends React.Component {
    ...
    async componentDidMount() {
        ...
        const respuesta = await fetch(`${Constantes.RUTA_API}/obtenerServicio.php?id=${idServicio}`);
    ...
    async manejarEnvioDeFormulario(evento) {
        ...
        // ¡Y enviarlo!
        const respuesta = await fetch(`${Constantes.RUTA_API}/actualizarServicio.php`, {
            method: "PUT",
            body: cargaUtil,
        });
