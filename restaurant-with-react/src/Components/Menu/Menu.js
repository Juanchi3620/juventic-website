	...
	return (
		<div>
			...
			<ContenedorHeader>
					...
					CONTÁCTANOS PARA PREGUNTAS O PEDIDOS
					</button>
			</ContenedorHeader>	

			<ContenedorPortada>
				<div>
					<h2><strong>Prueba un plato típico colombiano</strong></h2>
					<p ><em>Porque no importa donde te encuentres, celebramos este tiempo y sí que sabemos 
                            cómo celebrarlo, con lo que más te gusta: nuestra comida típica colombiana,
                            por eso <i>sal&salsa</i> piensa en tí, y por lo mismo pone a su disposición los 
                            mejores restaurantes para que te deleites con estos platos exquisitos y llenos 
